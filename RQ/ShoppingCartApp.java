// Program in Java to Use User Defined Package implement Shopping Cart app.
import shop.Taxable;
...
public class ShoppingCartApp {
    public static void main(String[] args) {
        Book book = new Book( 300, 1);
        Clothing clothing = new Clothing(1200, 2);
        Electronics electronics = new Electronics(5000, 1);
        double total = 0.0;
